...
const SummarizeLegalDocumentOutputSchema = z.object({
  ...
  keyPoints: z.string().describe('The key points and relevant clauses identified in the document.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert legal analyst. Your task is to summarize legal documents and identify key points.

Document Text: {{{documentText}}}

Provide a concise summary and highlight the key points and relevant clauses.
Summary:
Key Points: `,
});
